...
const Specialization = () => {
  ...
  const RobotRow = ({
    ...
    <div className="h-full pr-4 lg:pr-10 rounded-2xl bg-gray-100 shadow-[inset_0_4px_10px_rgba(0,0,0,0.3)] flex justify-between items-center gap-3 lg:gap-10">
      <h1 className="Cblue w-24 sm:w-32 lg:w-40 xl:w-56 shrink-0 h-full rounded-bl-2xl rounded-tl-2xl flex items-center justify-center font-bold text-white text-base lg:text-xl">
        {label}
      </h1>
      {children}
    </div>
