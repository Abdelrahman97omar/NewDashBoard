...
const Specialization = () => {
  ...
  const RobotRow = ({
    ...
    <div className="h-full pr-4 lg:pr-10 rounded-2xl bg-gray-100 shadow-[inset_0_4px_10px_rgba(0,0,0,0.3)] flex justify-start items-center gap-3 lg:gap-10">
  ...
  return (
    <>
      <div className="h-full grid grid-rows-5 gap-y-2">
        ...
        <RobotRow label="MOZO">
          <p
            className="p-1 lg:p-2 w-full max-w-[200px] lg:w-70 rounded-xl
             bg-[#E8E8E9] text-[#09203E] text-center  lg:text-2xl font-bold"
          >
            Tray 1
          </p>
          <p
