...
const Layout = () => {
  ...
  return (
    <div className="Cgray w-screen h-screen p-2 lg:p-4 overflow-hidden">
      <div className="grid grid-cols-[72px_1fr] sm:grid-cols-[100px_1fr] md:grid-cols-[220px_1fr] lg:grid-cols-[330px_1fr] h-full gap-2 lg:gap-0">

        <div className="grid grid-cols-1 lg:px-3.5 py-4 lg:py-10 Cblue overflow-auto rounded-3xl lg:rounded-4xl m-0 lg:m-3">
          <div className="flex justify-center items-center mt-2 mb-4 lg:mt-5 lg:mb-20 lg:h-1/2">
            <img className="w-auto p-1 sm:w-14 lg:w-auto" src={logo} />
          </div>
